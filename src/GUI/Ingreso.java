...
public class Ingreso extends javax.swing.JFrame {
	...
	/**
	 * Maneja el ingreso y regristro al persona. En el ingreso, se busca un objeto
	 * cuyo nombre de usuario y contraseña coinciada con lo que ingresa el usuario
	 * en la interfaz grafica. En el registro se debe verificar el input (no puede
	 * haber campos vacios). Si el tipo de usuario es un administrador o un
	 * veterinario, se debe ingresar una "clave secreta"
	 */
	public Ingreso() {
		initComponents();
	...
	/**
	 * Lee los datos (nombre de usuario, contraseña) desde el panel de ingreso
	 */
	private void ingresoLeerDatos() {
		this.nombreUsuario = inputIngresarUsuario.getText();
		this.contraseñaUsuario = String.valueOf(inputIngresarContraseña.getPassword());
	}

	/**
	 * Se leen los datos del registro: nombre, tipo de documento, documento,
	 * contraseña, tipo de usuario y clave secreta
	 */
	private void registroLeerDatos() {
		this.nombreUsuario = inputRegistrarseUsuario.getText();
		this.tipoDocumento = (inputRegistroTipoDoc.getSelectedItem()).toString();
		this.documento = inputRegistroDocumento.getText();
		this.contraseñaUsuario = String.valueOf(inputRegistraseContraseña.getPassword());
		this.tipoUsuario = (inputRegistroTipoUsuario.getSelectedItem()).toString();
		this.claveSecreta = inputRegistroUsuarioClave.getText();
	}

	/**
	 * Una vez se verifique el ingreso y/o el registro, se habre el programa
	 */
	...
	/**
	 * Esta función busca un usuario por su nombre. Para ello, busca en la lista de
	 * personas pprincipal aquel cuyo nombre coincida con el nombre dado.
	 * 
	 * @param nombreUsuario el nombre del usuario que buscamos.
	 * @return si la persona exite, se regresara el objeto persona. Si no exite, se
	 *         regresara null
	 */
	...
	private Persona crearPersona() {
		...
		// contraseña
		case "Usuario":
			this.user = (Usuario) new Veterinaria.Usuario(nombreUsuario, tipoDoc, documento, contraseñaUsuario);
			(PerrosPET.usuarios).add((Usuario) this.user);
			break;
		case "Veterinario":
			this.user = (Veterinario) new Veterinaria.Veterinario(nombreUsuario, tipoDoc, documento, contraseñaUsuario);
	...
	private void initComponents() {
		...
		PANEL_INGRESAR_CONTRASEÑA
				.setLayout(new javax.swing.BoxLayout(PANEL_INGRESAR_CONTRASEÑA, javax.swing.BoxLayout.LINE_AXIS));
		...
		PANEL_INGRESAR_BOTONESLayout.setHorizontalGroup(
				PANEL_INGRESAR_BOTONESLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(PANEL_INGRESAR_BOTONESLayout.createSequentialGroup().addGap(25, 25, 25)
								.addComponent(bottonIngresarIngresar, javax.swing.GroupLayout.PREFERRED_SIZE, 175,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(26, 26, 26)
								.addComponent(bottonIngresarRegistrarse, javax.swing.GroupLayout.PREFERRED_SIZE, 194,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addContainerGap(32, Short.MAX_VALUE)));
		PANEL_INGRESAR_BOTONESLayout.setVerticalGroup(
				PANEL_INGRESAR_BOTONESLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
						javax.swing.GroupLayout.Alignment.TRAILING,
						PANEL_INGRESAR_BOTONESLayout.createSequentialGroup()
								.addGroup(PANEL_INGRESAR_BOTONESLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
										.addComponent(bottonIngresarIngresar, javax.swing.GroupLayout.PREFERRED_SIZE,
												46, javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(bottonIngresarRegistrarse, javax.swing.GroupLayout.PREFERRED_SIZE,
												46, javax.swing.GroupLayout.PREFERRED_SIZE))
								.addGap(35, 35, 35)));
		...
		PANEL_REGISTRARSE_CONTRASEÑA
				.setLayout(new javax.swing.BoxLayout(PANEL_REGISTRARSE_CONTRASEÑA, javax.swing.BoxLayout.LINE_AXIS));
		...
		PANEL_REGISTRASE_DOCUMENTO
				.setLayout(new javax.swing.BoxLayout(PANEL_REGISTRASE_DOCUMENTO, javax.swing.BoxLayout.X_AXIS));
		...
		inputRegistroTipoDoc.setModel(
				new javax.swing.DefaultComboBoxModel(new String[] { "Cedula", "TI", "Pasaporte", "Cedula E" }));
		...
		PANEL_REGISTRASE_TIPO_USUARIO
				.setLayout(new javax.swing.BoxLayout(PANEL_REGISTRASE_TIPO_USUARIO, javax.swing.BoxLayout.X_AXIS));
		...
		inputRegistroTipoUsuario.setModel(
				new javax.swing.DefaultComboBoxModel(new String[] { "Usuario", "Veterinario", "Administrador" }));
		inputRegistroTipoUsuario
				.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(242, 237, 215)));
		...
		PANEL_REGITRASE_BOTTONESLayout.setHorizontalGroup(
				PANEL_REGITRASE_BOTTONESLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(PANEL_REGITRASE_BOTTONESLayout.createSequentialGroup().addGap(25, 25, 25)
								.addComponent(buttonRegistroIngresar, javax.swing.GroupLayout.PREFERRED_SIZE, 175,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(26, 26, 26)
								.addComponent(buttonRegistroRegistro, javax.swing.GroupLayout.PREFERRED_SIZE, 194,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		PANEL_REGITRASE_BOTTONESLayout.setVerticalGroup(
				PANEL_REGITRASE_BOTTONESLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
						javax.swing.GroupLayout.Alignment.TRAILING,
						PANEL_REGITRASE_BOTTONESLayout.createSequentialGroup()
								.addGroup(PANEL_REGITRASE_BOTTONESLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
										.addComponent(buttonRegistroRegistro, javax.swing.GroupLayout.PREFERRED_SIZE, 0,
												Short.MAX_VALUE)
										.addComponent(buttonRegistroIngresar, javax.swing.GroupLayout.DEFAULT_SIZE, 44,
												Short.MAX_VALUE))
								.addGap(37, 37, 37)));
		...
		ImagenLayout.setHorizontalGroup(
				ImagenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(toby_png,
		...
		FormLayout.setVerticalGroup(FormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0,
				552, Short.MAX_VALUE));
