...
public class Usuario extends javax.swing.JFrame {
        javax.swing.JPanel modulo1;
        javax.swing.JPanel modulo2;
        javax.swing.JPanel modulo3;
        
    public Usuario() {
        initComponents();
        String fotoPerfil = "/Resources/admi.png";
        ImageIcon imageIcon = new ImageIcon(new ImageIcon(getClass().getResource(fotoPerfil)).getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT));
        IMG_PEFIL.setIcon(imageIcon);

        modulo1 = new ModuloInfoUsuario();
        modulo2 = new ModuloCitas();
        ...
        // this.getContentPane().setBackground(new java.awt.Color(57,50,50));
    }
